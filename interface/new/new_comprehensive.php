...
<form action='new_comprehensive_save.php' name='demographics_form' id="DEM"  enctype = "multipart/form-data" method='post' onsubmit='return submitme(<?php echo $GLOBALS['new_validate'] ? 1 : 0;?>,event,"DEM",constraints)'>
